 ...
 */
package com.mycompany.varasto.controller.sales;
...
import com.mycompany.varasto.interfaces.SaleInterface;
import static com.mycompany.varasto.interfaces.SaleInterface.SALELIST;
...
public class SalesController implements Initializable, SaleInterface {
    ...
    // mutta muutettu vain Category saleksi ja joitan muita pieniä muutoksia GUI hin
    // hakee siis kaikki salet tietokannasta ja näyttää ne kaikki GUI ssa. en jaksa nyt kaikkiin samoja kommentteja tehd. Kaikki luokat hyvin samanlaisia
    @Override
    ...
    public void deleteAction(ActionEvent event) throws Exception {
        // ei ole vielä tullut tehtyä tätä
    }
}
